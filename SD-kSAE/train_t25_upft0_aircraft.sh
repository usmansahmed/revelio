...
mkdir -p $WORK/revelio/SD-kSAE/features/aircraft/SDv1-5/step25_upft0
...
python train_ksae.py \
  --model_name $WORK/revelio/SD-kSAE/aircraft/SDv1-5/timestep_25/up_blocks_0 \
  --feature_dir $WORK/revelio/SD-kSAE/features/aircraft/SDv1-5/step25_upft0 \
