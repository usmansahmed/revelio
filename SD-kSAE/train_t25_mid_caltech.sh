#!/bin/bash -l
#SBATCH --job-name=train_t25_mid_caltech
...
mkdir -p $WORK/revelio/SD-kSAE/features/caltech101/SDv1-5/step25_mid
...
python train_ksae.py \
  --model_name $WORK/revelio/SD-kSAE/caltech101/SDv1-5/timestep_25/mid_block \
  --feature_dir $WORK/revelio/SD-kSAE/features/caltech101/SDv1-5/step25_mid \
