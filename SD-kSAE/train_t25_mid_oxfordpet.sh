#!/bin/bash -l
#SBATCH --job-name=train_t25_mid_oxfordpet
...
mkdir -p $WORK/revelio/SD-kSAE/features/oxfordpet/SDv1-5/step25_mid
...
python train_ksae.py \
  --model_name $WORK/revelio/SD-kSAE/oxfordpet/SDv1-5/timestep_25/mid_block \
  --feature_dir $WORK/revelio/SD-kSAE/features/oxfordpet/SDv1-5/step25_mid \
