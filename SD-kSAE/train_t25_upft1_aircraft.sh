#!/bin/bash -l
#SBATCH --job-name=train_t25_upft1_aircraft
...
mkdir -p $WORK/revelio/SD-kSAE/features/aircraft/SDv1-5/step25_upft1
...
python train_ksae.py \
  --model_name $WORK/revelio/SD-kSAE/aircraft/SDv1-5/timestep_25/up_blocks_1 \
  --feature_dir $WORK/revelio/SD-kSAE/features/aircraft/SDv1-5/step25_upft1 \
