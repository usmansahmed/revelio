#!/bin/bash -l
#SBATCH --job-name=train_t25_upft2_caltech
...
mkdir -p $WORK/revelio/SD-kSAE/features/caltech101/SDv1-5/step25_upft2
...
python train_ksae.py \
  --model_name $WORK/revelio/SD-kSAE/caltech101/SDv1-5/timestep_25/up_blocks_2 \
  --feature_dir $WORK/revelio/SD-kSAE/features/caltech101/SDv1-5/step25_upft2 \
