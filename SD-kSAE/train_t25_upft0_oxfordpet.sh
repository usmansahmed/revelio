#!/bin/bash -l
#SBATCH --job-name=train_t25_upft0_oxfordpet
...
mkdir -p $WORK/revelio/SD-kSAE/features/oxfordpet/SDv1-5/step25_upft0
...
python train_ksae.py \
  --model_name $WORK/revelio/SD-kSAE/oxfordpet/SDv1-5/timestep_25/up_blocks_0 \
  --feature_dir $WORK/revelio/SD-kSAE/features/oxfordpet/SDv1-5/step25_upft0 \
