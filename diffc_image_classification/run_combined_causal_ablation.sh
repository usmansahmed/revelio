#!/bin/bash
#SBATCH --job-name=active_causal_combine
#SBATCH --partition=a100
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=4
#SBATCH --time=01:00:00
#SBATCH --output=logs/active_causal_combine_%j.out
#SBATCH --error=logs/active_causal_combine_%j.err
...
mkdir -p "$WORK/revelio/causal_results/image512/combined"
