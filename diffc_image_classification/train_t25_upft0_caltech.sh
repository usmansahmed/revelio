#!/bin/bash
#SBATCH --job-name=diffc_caltech_upft0
#SBATCH --partition=a100
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=4
#SBATCH --time=16:00:00
#SBATCH --output=logs/diffc_upft0_%j.out
#SBATCH --error=logs/diffc_upft0_%j.err
...
echo "Starting up_ft:0 training"
...
echo "up_ft:0 training finished"
